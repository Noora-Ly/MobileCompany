 ...
 * @author Noora
 */
public class MobileCompanyUi extends javax.swing.JFrame {

    public MobileCompanyUi() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MobileCompanyUi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MobileCompanyUi().setVisible(true);
            }
        });
    }
